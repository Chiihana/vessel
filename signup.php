...
<body>
    ...
    ?>
     <div class="container">
                    <div id="output">
                        <center> <p><b><div class="title">SIGNUP</b></p></center></br>
                                <div class="content1">
                                ...
                                <form class="comment" action="" method="post">
                                 <fieldset>
                                        ...
                                        <div class="form-group no-margin">
                                                <input id="name" name="name" type="name" class="form-control input-lg" placeholder="NAME">
                                        </div>
                                         <div class="form-group no-margin">
                                                <input id="lastname" name="name" type="lastname" class="form-control input-lg" placeholder="LASTNAME">
                                        </div>
                                         <div class="form-group no-margin">
